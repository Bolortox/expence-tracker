...
export const AddRecord = () => {
  ...
  return (
    <dialog open>
      <div className="w-[792px] flex bg-white rounded-3xl h-[512px] z-[1] absolute top-1/2 left-1/2 transform -translate-x-1/2 border-2 flex-col">
        <div className="font-bold text-lg h-[68px] flex justify-between items-center py-5 px-6 w-full border-b-2 border-slate-200">
          <p>Add Record</p>
